...
$categotries = mysqli_query($connection,$query);
?>
...
<?php if (isset($_SESSION['add-category-success'])) :  // shows if add category was successfully?>
    ...
    <?php elseif (isset($_SESSION['delete-category-success'])) :  // shows if delete category was Not successfully?>
        <div class="alert__message success container">
            <p>
                <?=
    ...
    <div class="container dashboard__container">
        ...
        <aside>
            <ul>
                ...
                <li>
                    <a class="active" href="manage-categories.php">
        ...
        <main>
            ...
            <?php if(mysqli_num_rows($categotries)>0) : ?>
            <table>
                <thead>
                    <tr>
                        <th>Title</th>
                ...
                <tbody>
                <?php while($categotry=mysqli_fetch_assoc($categotries)) : ?>
                    <tr>
                        <td><?= $categotry['title'] ?></td>
                        <td><a href="<?=ROOT_URL?>admin/edit-category.php?id=<?=$categotry['id']?>" class="btn sm">Edit</a></td>
                        <td><a href="<?=ROOT_URL?>admin/delete-category.php?id=<?=$categotry['id']?>" onclick="return confirm('Are you sure?')" class="btn sm danger">Delete</a></td>
                    </tr>
                    <?php endwhile ?>
                </tbody>
            </table>

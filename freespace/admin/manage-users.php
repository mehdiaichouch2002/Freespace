...
<section class="dashboard">
    ...
    <?php elseif (isset($_SESSION['dalete-user'])) :  // shows if delete user was NOT successfully?>
        <div class="alert__message error container">
            <p>
                <?=
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a onclick="return confirm('Do you want to delete <?= $user['username'] ?>?')" href="<?= ROOT_URL ?>admin/delete-user.php?id=<?=$user['id']?>" class="btn sm danger">Delete</a></td>

...
$query2 = "SELECT id,title,category_id,author_id FROM posts ORDER BY date_time DESC";
$posts = mysqli_query($connection, $query);
$all_posts = mysqli_query($connection, $query2);
?>
<section class="dashboard">
    ...
    <div class="container dashboard__container">
        ...
        <main style="overflow: scroll;height:450px;overflow-x: hidden;">
            <h2>Manage Posts</h2>
            <?php if (mysqli_num_rows($posts) > 0) : ?>
                <table>
                    ...
                    <tbody>
                        <?php while ($post = mysqli_fetch_assoc(isset($_SESSION['user_is_admin']) ? $all_posts : $posts)) : ?>
                            <!-- get category id of each post from table -->
                            <?php
                            ...
                            <tr>
                                ...
                                <td><a href="<?= ROOT_URL ?>admin/delete-post.php?id=<?= $post['id'] ?>" onclick="return confirm('Are you sure?')" class="btn sm danger">Delete</a></td>
                            </tr>
                        <?php endwhile  ?>
                    </tbody>
                </table>
